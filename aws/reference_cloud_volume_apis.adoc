...
[
  {
    ...
    [blue]#"name"#: [green]#"SMB"#,
    [blue]#"ownerId"#: [green]#"d38839c3-a37f-4426-9ef9-ae7569e59f1d"#,
    [blue]#"region"#: [green]#"us-west"#,
    [blue]#"creationToken"#: [green]#"prickly-bellicose-archimedes"#,
    [blue]#"quotaInBytes"#: 1000000000000,
    [blue]#"serviceLevel"#: [green]#"standard"#,
    [blue]#"snapReserve"#: 0,
    [blue]#"timezone"#: [green]#"PT"#,
    [blue]#"usedBytes"#: 0
  }
]
``
