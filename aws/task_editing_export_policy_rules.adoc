...
summary: You can edit the export policy rule for a volume to change client access, the access type, or protocol support.
---
...
[.lead]
You can edit the export policy rule for a volume to change client access, the access type, or protocol support.
