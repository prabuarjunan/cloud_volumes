...
If you are deploying and managing your AD installation domain controllers and member servers on an AWS EC2 instance, you will require several security group rules to allow traffic for the Cloud Volumes Service. We have provided an example of how to implement these rules for AD application as part of the AWS CloudFormation template.

Click https://github.com/prabuarjunan/AD-SG-json/blob/master/CVS-AD-json[here^] to access the code in a GitHub repository.
