...
* *Active Directory*
+
If you selected SMB or Dual-protocol, you can select **Enable data encryption**, and you can integrate the volume with a Windows Active Directory server by providing the following information:
