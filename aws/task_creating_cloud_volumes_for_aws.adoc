...
+
If you selected SMB or Dual-protocol, you can enable data encryption by selecting the checkbox. Selecting the checkbox enables SMB session encryption on a per share basis.
