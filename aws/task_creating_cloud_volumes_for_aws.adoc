...
+
. Accept the virtual interfaces as described in section 6.4 of the link:media/cvs_aws_account_setup.pdf#accept_interfaces[NetApp Cloud Volumes Service for AWS Account Setup] guide. You must perform this task within 10 minutes or the system may time out.
+
